                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-card p-8 rounded-lg border border-gray-800 text-center hover:border-primary hover:shadow-[0_0_50px_rgba(20,184,166,0.6)] transition-all duration-300 group"
                            >
